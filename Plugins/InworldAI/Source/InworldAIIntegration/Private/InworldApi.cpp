...
void UInworldApiSubsystem::RegisterCharacterComponentOnClient(Inworld::ICharacterComponent* Component)
{
    CharacterComponentByAgentId.Add(Component->GetAgentId(), Component);
}

void UInworldApiSubsystem::UnregisterCharacterComponentOnClient(Inworld::ICharacterComponent* Component)
{
