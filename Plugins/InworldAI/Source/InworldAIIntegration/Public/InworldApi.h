...
public:
	...
	void RegisterCharacterComponentOnClient(Inworld::ICharacterComponent* Component);
	void UnregisterCharacterComponentOnClient(Inworld::ICharacterComponent* Component);
